...
export const saisTheme = {
  ...
  imageHighlight: "#F48FB1",
  compImgHighlight: "#C5CAE9",
  jacketColor: "#FFE082",
  headerColor: "#3E2723",
  splashBg: "#1E88E5",
};
...
export const sai2 = {
  body: "#f5f5f5", // Light grey for a clean background
  text: "#333333", // Dark grey for better readability
  expTxtColor: "#4a4a4a", // Slightly lighter grey for secondary text
  highlight: "#ff6f61", // Coral for a vibrant highlight
  dark: "#2c3e50", // Dark blue-grey for depth
  secondaryText: "#7f8c8d", // Medium grey for secondary elements
  imageHighlight: "#2980b9", // Bright blue for image highlights
  compImgHighlight: "#bdc3c7", // Light grey for component highlights
  jacketColor: "#ecf0f1", // Very light grey for subtle contrast
  headerColor: "#34495e", // Dark blue-grey for headers
